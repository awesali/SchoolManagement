namespace SchoolManagement.DTOs
{
    ...
    public class StudentOrderRequest { public int SchoolId { get; set; } public int AcademicSessionId { get; set; } public int StudentId { get; set; } public int EnrollmentId { get; set; } public List<StudentOrderItemRequest> Items { get; set; } = new(); }
